...
export default function Navbar() {
  ...
  return (
    <nav className="relative flex justify-between items-center px-12 py-8 overflow-hidden">
      ...
      <div className="relative group">
        <div className="text-2xl font-bold text-gray-800 transition-all duration-300 group-hover:scale-105 cursor-pointer" style={{ fontFamily: 'cursive' }}>
          Aakash
        </div>
      ...
      <div className="relative flex items-center space-x-8 backdrop-blur-sm bg-white/30 rounded-full px-6 py-2 border border-gray-200/50">
        {navItems.map((item) => (
          ...
          >
            ...
            {/* Active indicator */}
            {item.id === 'services' && (
              <div className="absolute inset-0 bg-gray-800/10 rounded-full backdrop-blur-sm border border-gray-800/20"></div>
            )}
